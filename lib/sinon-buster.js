...
(function (ba) {
    ...
    ba.add("calledWith", function (spy, args) {
        verifyFakes(spy);
        return spy.calledWith.apply(spy, args);
    }, {
        ...
        values: function (spy, args) { return [spy, args, spy.printf("%C")]; }
    });

    ba.add("alwaysCalledWith", function (spy, args) {
        verifyFakes(spy);
        return spy.alwaysCalledWith.apply(spy, args);
    }, {
    ...
    ba.add("calledWithExactly", function (spy, args) {
        verifyFakes(spy);
        return spy.calledWithExactly.apply(spy, args);
    }, {
    ...
    ba.add("alwaysCalledWithExactly", function (spy, args) {
        verifyFakes(spy);
        return spy.alwaysCalledWithExactly.apply(spy, args);
    }, {
